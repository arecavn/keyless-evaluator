...
### Ngành kinh tế — định nghĩa rộng
Khi query nhắc "ngành kinh tế", đây là nhóm ngành **rộng**, bao gồm tất cả các chuyên ngành sau:
kinh doanh, bán hàng (sales), tài chính, kế toán, kiểm toán, ngân hàng, marketing,
quản trị kinh doanh, thương mại, logistics, xuất nhập khẩu, đầu tư, bảo hiểm.
- "Nhân viên kinh doanh / bán hàng" **thuộc ngành kinh tế** — KHÔNG trừ điểm vì "chỉ là sales"
- Sales Engineer với nội dung kinh doanh là chính → vẫn thuộc khối kinh tế, có thể giảm 1 điểm nếu phần kỹ thuật chiếm phần lớn mô tả
- KHÔNG yêu cầu job title phải chứa từ "kinh tế" — chỉ cần thuộc lĩnh vực trên
...
## Các tiêu chí KHÔNG trừ điểm khi query không đề cập
- **Part-time / bán thời gian**: KHÔNG trừ điểm nếu query không nêu yêu cầu full-time
- **Giới tính** (Nam/Nữ trong title): KHÔNG trừ điểm nếu query không nêu yêu cầu giới tính
- **Địa điểm**: KHÔNG trừ điểm nếu query không nêu địa điểm cụ thể
- Nguyên tắc chung: chỉ trừ điểm những gì **query đặt ra**, không tự suy diễn thêm ràng buộc
